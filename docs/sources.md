...
| --- | --- | --- | --- | --- | --- |
| [IMF lending rates (MFS_IR)](https://data.imf.org/en/Data-Explorer) | `imf_lending_rates.csv`<br>fetch: fallback (staged copy wins) | monthly | — | lcarey@rmi.org | `10_build_themes.R` |
| [IMF PCPS derived volatility by commodity series](https://www.imf.org/en/research/commodity-prices) | `imf_pcps_price_volatility_series.csv` | monthly | — | lcarey@rmi.org | `05_ingest_sources.R` |
| [IMF PCPS derived volatility by technology](https://www.imf.org/en/research/commodity-prices) | `imf_pcps_price_volatility.csv` | monthly | — | lcarey@rmi.org | `05_ingest_sources.R` |
| [IMF Primary Commodity Price System (monthly price panel)](https://www.imf.org/en/research/commodity-prices) | `imf_pcps_prices.csv` | monthly | — | lcarey@rmi.org | `05_ingest_sources.R`, `10_build_themes.R` |
| [IMF producer price indices (PPI)](https://data.imf.org/en/Data-Explorer) | `imf_ppi.csv`<br>fetch: fallback (staged copy wins) | monthly | — | lcarey@rmi.org | `10_build_themes.R` |
...
| [World Bank WDI country reference table](https://databank.worldbank.org/source/world-development-indicators) | `wdi_country_info.csv` | annual | — | lcarey@rmi.org | `05_ingest_sources.R`, `10_build_themes.R`, `15_build_partner_themes.R`, `30_build_allied_network_design.R` |
...
| [IEA relative technology cost extract](https://www.iea.org/data-and-statistics) | `Relative_Costs_IEA.csv` | irregular | — | lcarey@rmi.org | `10_build_themes.R` |
...
| [IMF commodity prices (wide export, includes annual YoY series)](https://www.imf.org/en/research/commodity-prices) | `imf_commodity_prices.csv` | monthly | — | lcarey@rmi.org | `10_build_themes.R` |
...
| [IMF Primary Commodity Price System full workbook](https://www.imf.org/en/research/commodity-prices) | `IMF_PCPS_all.xlsx` | monthly | — | lcarey@rmi.org | `05_ingest_sources.R` |
